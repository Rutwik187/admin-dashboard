  ...
  return (
    <div className="@container flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">Owner's dashboard for profitability and control</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 @md:grid-cols-2">
        <Card className="transition-shadow hover:shadow-md">
          <CardHeader>
            ...
            <CardDescription>See exactly where money is leaking. Compare wastage across outlets</CardDescription>
          </CardHeader>
          <CardContent>
